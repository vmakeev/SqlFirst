...
{
	internal static class DescribeUserTypeByIdQuery
	{
		/// <summary>
		...
		{
			return @"select * from sys.types where user_type_id = @userTypeId";
		}
		...
		public static MsSqlServerTypeDescription GetFirst(IDbConnection connection, int? userTypeId)
		{
			using (IDbCommand cmd = connection.CreateCommand())
			{
				cmd.CommandText = GetQueryText();
				AddParameter(cmd, SqlDbType.Int, "@userTypeId", userTypeId);
