...
{
	internal class StoredProcedureWithScalarResultAbility : QueryObjectAbilityBase
	{
		/// <inheritdoc />
		...
		protected virtual IRenderableTemplate GetTemplate() => Snippet.Query.Methods.StoredProcedure.StoredProcedureWithScalarResult;
