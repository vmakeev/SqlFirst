...
{
	internal class SelectItemsIAsyncEnumerableAsyncAbility : QueryObjectAbilityBase
	{
		/// <inheritdoc />
		...
		public override IQueryObjectData Apply(ICodeGenerationContext context, IQueryObjectData data)
		{
			...
			string method = Snippet.Query.Methods.Get.GetIAsyncEnumerableAsync.Render(new
			{
