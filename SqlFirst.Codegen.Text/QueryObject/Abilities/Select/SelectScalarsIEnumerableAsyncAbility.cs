...
{
	internal class SelectScalarsIEnumerableAsyncAbility : QueryObjectAbilityBase
	{
		/// <inheritdoc />
		...
		public override IQueryObjectData Apply(ICodeGenerationContext context, IQueryObjectData data)
		{
			...
			string method = Snippet.Query.Methods.Get.GetIEnumerableScalarsAsync.Render(new
			{
