...
{
	internal class UpdateWithResultAsyncAbility : UpdateWithResultAbility
	{
		/// <inheritdoc />
		...
		protected override IRenderableTemplate GetTemplate() => Snippet.Query.Methods.Update.UpdateWithResultAsync;
	}
}