...
{
	internal class UpdateWithScalarResultAsyncAbility : UpdateWithScalarResultAbility
	{
		/// <inheritdoc />
		...
		/// <inheritdoc />
		protected override IRenderableTemplate GetTemplate() => Snippet.Query.Methods.Update.UpdateWithScalarResultAsync;
	}
}