...
{
	internal class DeleteWithScalarResultAbility : QueryObjectAbilityBase
	{
		/// <inheritdoc />
		...
		protected virtual IRenderableTemplate GetTemplate() => Snippet.Query.Methods.Delete.DeleteWithScalarResult;
